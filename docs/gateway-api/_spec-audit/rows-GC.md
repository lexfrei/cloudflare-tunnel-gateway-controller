...
| GC-05 | SHOULD | CTRL | GAP | internal/controller/gatewayclass_controller.go:104-114 | setAcceptedConditions always sets Accepted=True; never validates parametersRef nor sets Accepted=False/InvalidParameters. Resolver (internal/config/resolver.go:116-127 ResolveFromGatewayClass) detects bad refs but its errors never reach GatewayClass status. |
