...
func TestBuildEdgeWebSocketConfig(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			edgeHost:         "cf-conformance-test.lexfrei.dev",
			wantLocation:     "wss://cf-conformance-test.lexfrei.dev/ws",
		...
		},
		{
			...
			origin:           "ws://gateway/TestWebSocket",
			edgeHost:         "cf-conformance-test.lexfrei.dev",
			wantLocation:     "wss://cf-conformance-test.lexfrei.dev/ws?foo=bar",
			wantOriginalHost: "abcd1234.cfargotunnel.com",
		},
		{
		...
		},
		{
			...
			rawURL:           "ws://cf-conformance-test.lexfrei.dev/ws",
			origin:           "ws://gateway/TestWebSocket",
			edgeHost:         "cf-conformance-test.lexfrei.dev",
			wantLocation:     "wss://cf-conformance-test.lexfrei.dev/ws",
			wantOriginalHost: "",
