...
//
// The shares normally sum to one less than the document's rule count: the
// catch-all closing the document is the controller's own and belongs to no
// namespace. Duplicate rules widen that gap, since the diff keeps every copy.
